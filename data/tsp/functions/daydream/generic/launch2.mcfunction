...
execute store result entity @s Motion[0] double 0.0016 run scoreboard players get @s g_dx
execute store result entity @s Motion[1] double 0.0006 run scoreboard players get @s g_dy
execute store result entity @s Motion[2] double 0.0016 run scoreboard players get @s g_dz
