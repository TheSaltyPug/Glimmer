...
execute if block ~ ~ ~ #tsp:glimmer/air unless score @s tsp.glim.dummy matches 12.. run execute positioned ^ ^ ^0.7 run function tsp:glimmer/spells/ender/blink_raycast
